        ...
        <View>
            ...
            <View style={styles._prevent_item_text}>
                <View style={styles.iconSideBySide}>
                    <BiUser style={{marginRight: 0, margin: 0, height: '60px', width: '60px' }} />
                ...
                <h3 style={{ marginTop: 0, margin: 0 }}>Stay 6 feet away from others</h3>
                <Paragraph style={styles._prevent_item_text}>{paragraph4}</Paragraph>
            </View>
            <View style={styles._prevent_item_text}>
                <GiSyringe style={{ margin: 20, height: '60px', width: '60px' }} />
                <h3 style={{ marginTop: 0, margin: 0 }}>Get Vaccinated</h3>
                <Paragraph style={styles._prevent_item_text}>{paragraph5}</Paragraph>
            </View>
            <View style={styles._prevent_item_text}>
                <FaBriefcaseMedical style={{ margin: 20, height: '60px', width: '60px' }} />
                <h3 style={{ marginTop: 0, margin: 0 }}>Monitor your health daily</h3>
                <Paragraph style={styles._prevent_item_text}>{paragraph6}</Paragraph>
            </View>
            <View style={styles._prevent_item_text}>
                <GiBroom style={{ margin: 20, height: '60px', width: '60px' }} />
                <h3 style={{ marginTop: 0, margin: 0 }}>Clean and disinfect</h3>
